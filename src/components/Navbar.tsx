...
const Navbar: React.FC<NavBarProps> = ({ setShowSideBar }) => {
  return (
    <div className="mx-auto bg-slate-200  flex flex-wrap items-center justify-between shadow-xs mr-7 ml-1 md:mr-13 md:ml-7">
      <button
      ...
      <ul className="flex flex-wrap items-center text-base justify-center">
        ...
        <li>
          <button className="inline-flex items-center text-black bg-red py-2 rounded-md px-5">
            Sign In
          </button>
        </li> */}
      </ul>
