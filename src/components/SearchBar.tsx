...
function SearchBar() {
  return (
    <div className="flex justify-center mx-6 items-center mb-3">
      ...
      <Link to={'/add-contact'}>
        <button className="bg-cyan-500 hover:bg-white text-white hover:text-cyan-500 font-bold py-2 px-4 rounded-lg inline-flex items-center whitespace-nowrap">
          <div className="w-5 absolute">
            ...
            >
              ...
              <path
                ...
                fill="white" className='hover:text-cyan-500'
              />
            </svg>
          </div>
