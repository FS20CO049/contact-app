    ...
    >
      ...
      <div className="flex">
        <Link to={`edit-contact/${id}`}>
          <button className="bg-cyan-500 hover:bg-gray-400 text-white font-bold py-2 px-4 mt-3 rounded inline-flex items-center">
            <div className="w-6 mr-1">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path d="M20.548 3.452a1.542 1.542 0 0 1 0 2.182l-7.636 7.636-3.273 1.091 1.091-3.273 7.636-7.636a1.542 1.542 0 0 1 2.182 0zM4 21h15a1 1 0 0 0 1-1v-8a1 1 0 0 0-2 0v7H5V6h7a1 1 0 0 0 0-2H4a1 1 0 0 0-1 1v15a1 1 0 0 0 1 1z" color='white' />
              </svg>
            </div>
            <span>Edit</span>
          </button>
        ...
        <button
          className="bg-red-500 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 mt-3 ml-2 rounded inline-flex items-center"
